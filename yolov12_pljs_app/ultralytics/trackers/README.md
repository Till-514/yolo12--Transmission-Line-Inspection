...
model = YOLO("path/to/best_by_v12n_1W.pt")  # Load a custom trained model
...
yolo track model=path/to/best by v12n_1W.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/best by v12n_1W.pt tracker="bytetrack.yaml"
```
